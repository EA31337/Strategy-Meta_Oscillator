...
INPUT_GROUP("Meta Oscillator Filter strategy: RSI oscillator params");
INPUT int Meta_Oscillator_Filter_RSI_Period = 16;                                    // Period
INPUT ENUM_APPLIED_PRICE Meta_Oscillator_Filter_RSI_Applied_Price = PRICE_WEIGHTED;  // Applied Price
INPUT int Meta_Oscillator_Filter_RSI_Shift = 0;                                      // Shift
INPUT ENUM_IDATA_SOURCE_TYPE Meta_Oscillator_Filter_RSI_SourceType = IDATA_BUILTIN;  // Source type
